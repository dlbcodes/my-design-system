  ...
  return new Proxy(cache, {
    get(target, prop, receiver) {
      if (typeof prop === "string") {
        ...
        if (c5 >= 48 && c5 <= 57) {
          const i9 = +prop;
          if (Number.isInteger(i9) && i9 >= 0 && i9 < count) {
            let v4 = target[i9];
            if (!v4) {
              const s7 = flat[i9 * 2];
              v4 = target[i9] = {
  ...
  constructor(opts) {
    ...
    this.getVirtualItemForOffset = (offset) => {
      ...
      const idx = findNearestBinarySearch(
        ...
        useFlat ? (i9) => flat[i9 * 2] : (i9) => notUndefined(measurements[i9]).start,
        offset
      );
...
//# sourceMappingURL=chunk-4DZQ2NHH.js.map
